...
const getLayouts = () => {
    ...
    return {
        lg: [
            ...
            { x: 0,  y: 0,  w: 12, h: tradingChartHeight,    i: '2', minH: minTradingChartHeight, minW: 5, isDraggable: isDraggable, isResizable: isResizable },
            { x: 16, y: 0,  w: 4,  h: recentTradesHeight,    i: '3', minH: minRecentTradesHeight, minW: 4, isDraggable: isDraggable, isResizable: isResizable },
            { x: 0,  y: 40, w: 12, h: minMarketDepthsHeight, i: '4', minH: minMarketDepthsHeight, minW: 5, isDraggable: isDraggable, isResizable: isResizable },
            { x: 0,  y: 60, w: 12, h: openOrdersHeight,      i: '5', minH: minOpenOrdersHeight,   minW: 5, isDraggable: isDraggable, isResizable: isResizable },
            { x: 12, y: 0,  w: 4,  h: orderBookHeight,       i: '6', minH: minOrderBookHeight,    minW: 4, isDraggable: isDraggable, isResizable: isResizable },
